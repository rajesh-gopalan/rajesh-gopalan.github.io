---
title: "Return On Ad Spending [ROAS]"
author: "Raj Gopalan"
date: "Project done as part of UCLA MBA, Marketing Analytics course"
output: pdf_document
---
...
lm.4.Results <- lm(data = df1.tg.March,
...
I had noted earlier that when the A/B testing was in progress in March, the sales in test group were higher on average than those of control group.  Now, I would like to run a linear regresion of the average sales in the test period (grouped by gma) against the cost.clicks and the sales in the pre-test period.  
The hypothesis is that:  
1. If ad spending (cost.clicks) improved sales, I should see a statistical significance of the ad spending.  
2. By using sales in the pre-test period as an independent variable, it would take away that component of sales, which is related to organic search, leaving behing the sales numbers related to the paid search, i.e. the incremental sales lift.
